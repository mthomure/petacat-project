function x = randf(DIM,BETA)
    % function x = randf(dim, alpha)
    %
    % alpha = 0,-1,-2,'white','pink','red','brownian'
    %
    ...
    if ischar(BETA)
        ...
        if strcmp(BETA,'white')
            BETA = 0;
        elseif strcmp(BETA,'pink')
            BETA = -1;
        elseif strcmp(BETA,'red')
            BETA = -2;
        elseif strcmp(BETA,'brownian')
            BETA = -2;
        elseif strcmp(BETA,'brown')
            BETA = -2;
        end
