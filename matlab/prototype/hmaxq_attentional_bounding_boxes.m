...
function [centroids,boxes] = hmaxq_attentional_bounding_boxes( fnames, k, show_figs )

    % [centroids,boxes] = hmaxq_attentional_bounding_boxes( fnames, k, show_figs );
    %
    ...
    % process inputs
        ...
        % load and process images through C1
                % takes an hmaxq model specification (initialized above)
                % and a list of filenames in a cell array
            data = hmaxq_fn2c1( model, fnames );
