...
mxArray*getFieldByName(const mxArray*A,int i, string fname){
	...
	assert(mxIsStruct(A)&&isField2(A,fname2));//inefficient?
...
//     ASSERT(mxIsStruct(A)&&isField2(A,fname));
